...
function CreatePage() {
	...
	return (
		<div className="page-wrap max-w-2xl py-14">
			...
			<p className="mt-3 text-lg text-ink-soft">
				Your first board is free — up to 5 signatures in total, each friend gets
				one, and you can add up to 2 notes of your own. Unlock it any time for a
				flat ₦1,000: unlimited signing, exports and voice notes. The people who
				sign never pay.
			</p>
